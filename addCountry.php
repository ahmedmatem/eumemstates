        ...
        <div id="containerId">
            ...
            <div id="main-content">
                <div class="row">
                    ...
                    <h1 class="col-md-10">Add new country</h1>
                </div>
                
                <form action="addProcesse.php" method="post" id="add-form" enctype="multipart/form-data" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="inputCapitalName" name="inputCapitalName" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input type="text" class="form-control" id="inputPopulation" name="inputPopulation" />
            ...
            <script>
                ...
                $('button[type="submit"]').click(function (e) {
                    ...
                    if(fileName == ""){
                        $('#err-message-flag').html('Select file, please.').show();
                        flag_err = true;
                    }
                    else {
